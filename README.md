...
├── apps/            # Self-hosted applications (Immich VPU/NPU, RKNN Detectors, rad-mon, Paperless, Recoll)
...
- [**rad-mon Hardware Telemetry Utility**](./apps/rad-mon/): Mobile-optimized (37-column) real-time ANSI telemetry dashboard monitoring CPU, NPU, GPU, VPU, PWM Fan, RAM, and Swap.
